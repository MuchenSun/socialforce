"""
This test is based on test4, for adaptive thresholding for
distance field
"""

import sys
sys.path.append('/home/msun/Code/socialforce')
if '/home/msun/catkin_ws/devel/lib/python2.7/dist-packages' in sys.path:
    sys.path.remove('/home/msun/catkin_ws/devel/lib/python2.7/dist-packages')
...
def animate3(states, space, dest=None):
    ...
    # Figure 3: ditance field after adaptive thresholding
    ...
    def sub_animate(t): # i indicates time step
        ...
        # Figure 3: adaptive thresholding for distance field
        ax3.clear()
        # vals_th, th = cv2.adaptiveThreshold(vals, 50, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 11, 2)
